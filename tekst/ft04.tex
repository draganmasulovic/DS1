...
\textit{Re\v senje.}
    ...
    na krugu kako je to pokazano na slici. Tada je svaka izme\dj u one druge dve i to samo treba formalno
    da zapi\v semo.
...
\noindent
  Dokazati da po okon\v canju ovog koda promenljiva $m$ sadr\v zi najve\'ci element niza~$A$, a promenljiva $p$ njegovu

...
\item Simetri\v cnost i tranzitivnost impliciraju refleksivnost.
...
\end{center}
\begin{enumerate}[(a)]
\item Predstaviti relaciju $\rho$ crte\v zom,
...
\ZAD{08.zad.11}{
Proveriti da li je $\rho$ relacija ekvivalencije na ravni $\mathbb R^2$ i opisati sve njene klastere, ako je:
\begin{enumerate}[(a)]
...
\ZAD{08.zad.12}{
Dokazati da je $\rho$ relacija ekvivalencije na ravni $\mathbb R^2$, gde je:
\begin{center}
$(m,n)\mathrel\rho(p,q)$ akko $m+q=n+p$.
\end{center}
Odrediti klastere elemenata $(1,1)$, $(2,1)$, $(3,1)$ i $(1,3)$. Opisati sve klastere relacije $\rho$.
}
...
\ZAD{09.zad.1}{
Da li je relacija deljivosti relacija poretka na skupu prirodnih brojeva? Da li ona ima najmanji, i da li ima najve\' ci element? Odgovoriti na ista pitanja za relaciju deljivosti na skupu celih brojeva.
}

\ZAD{09.zad.2}{
 Odgovoriti za\v sto $\rho$ nije relacija poretka na skupu $A$, ako je:
\begin{enumerate}[(a)]
...
\item $A$ je skup ljudi u kojem nikoje dve osobe nemaju isti broj godina, niti su iste visine. Za osobe $P$ i $Q$ iz skupa $A$ pi\v semo $P\mathrel\rho Q$ akko je
\begin{center}
...
\end{enumerate}
\end{multicols}
Za svaki od skupova odrediti minimalne i maksimalne elemente, kao i najmanji i najve\' ci element, ukoliko postoje.
}

\ZAD{09.zad.9}{
Neka je $A=\{0,1,2\}\times \{2,5,8\}$. Proveriti da li je $\rho$ relacija poretka na $A$ ako je
\begin{center}
...
\begin{center}
$x\mathrel\rho y$ akko $x=y\vee \big(x\mid y\wedge(\exists p\in\mathbb P)(p\mid y\wedge p\mathrel{\not|}x)\big),$
\end{center}
gde je $\mathbb P$ skup prostih brojeva.
\begin{enumerate}[(a)]
\item Predstaviti crte\v zom relaciju $\rho$ sa brojevima 1, 2, 3, 4, 5, 6, 8, 10 i 12.
...
\end{center}
\begin{enumerate}[(a)]
\item Predstaviti crte\v zom relaciju $\rho$ sa brojevima 1, 2, 3, 4, 6, 8, 9 i 12.
\item Odgovoriti na pitanja da li je $\rho$ refleksivna, simetri\v cna, antisimetri\v cna i tranzitivna.
\item Proveriti da li je $\rho$ relacija ekvivalencije, i da li je relacija poretka.
\item Ako je $\rho$ relacija poretka, nacrtati njen Hase dijagram sa brojevima 2, 3, 5, 6, 8, 9, 10, 12, 16, 18, 20, 25, 30 i 144, i proveriti da li je $\rho$ relacija totalnog poretka.
\end{enumerate}
}
...
\end{center}
\begin{enumerate}[(a)]
\item Predstaviti crte\v zom relaciju $\rho$ sa prvih deset prirodnih brojeva.
\item Odgovoriti na pitanja da li je $\rho$ refleksivna, simetri\v cna, antisimetri\v cna i tranzitivna.
\item Proveriti da li je $\rho$ relacija ekvivalencije, i da li je relacija poretka.

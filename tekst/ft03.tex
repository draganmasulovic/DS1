...
\begin{NAP}\it
Za prirodni broj $k$ i cele brojeve $m$ i $n$ pi\v semo $n\equiv_k m$ ako $n-m$ deljivo brojem $k$. Tada ka\v zemo da je su brojevi $n$ i $m$ kongruentni po modulu $k$.
...
i onda je, koriste\'ci pogone tautologije, svesti na ekvivalentan oblik kod koga logi\v cki veznik~$\lnot$ napada samo iskazna slova.
\end{NAP}
